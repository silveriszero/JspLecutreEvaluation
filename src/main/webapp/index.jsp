...
<%
	...
	if(emailChecked == false){
		PrintWriter script = response.getWriter();
		script.println("<script>");
		script.println("location.href = 'emailSendConfrim.jsp'");
		script.println("</script>");
		script.close();
		return;
	}
%>
	...
	<section class="container">
		<form method="get" action="./index.jsp" class="form-inline mt-3">
			...
			<a class="btn btn-primary mx-2 mt-2" data-toggle="modal" href="#registerModal">등록하기</a>
	...
	%>
		<div class="card bg-light mt-3">
			<div class="card-header bg-light">
				<div class="row">
					<div class="clo-8 text-left"> <%=evaluation.getLectureName()%> &nbsp;<small> <%=evaluation.getProfessorName()%> </small></div>
			...
			<div class="card-body">
				...
				<div class="row">
					...
					<div class="col-3 text-rigth">
						<a onclick="return confirm('추천하시겠씁니까?')" href="./likeAction.jsp?evaluationID=<%=evaluation.getEvaluationID()%>"> 추천 </a>
		...
		<ul class="pagination justify-content-center mt-3">
			...
			<% if(evaluationList.size()< 6){ %>
				<a class="page-link disavled">다음</a>
			<% } else { %>
		...
		<!-- 등록하기 Modal -->
		<div class="modal fade" id="registerModal" tabindex="-1" role="dialog" aria-lavelledby="modal" aria-hidden="true">
					...
					<div class="modal-body"> 
						<form action="./evaluationRegisterAction.jsp" method="post">
							<div class="form-row ">
								...
								<div class="form-group clo-sm-6">
									<label>교수명</label>
									<input type="text" name="professorName" class="form-control" maxlength="20">
								</div>							
							</div>
							<div class="form-row">
								<div class="form-group clo-sm-4">
									<label>수강 연도</label>
							...
							<div class="form-group">
								<label>내용</label>
								<textarea name="evaluationContent" class="form-control" maxlength="2048" style="hegiht:180px;"></textarea>
							</div>
							<div class="from-row">
